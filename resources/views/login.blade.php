...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/sitoya.png" rel="icon">
    <link href="assets/img/sitoya.png" rel="apple-touch-icon">
                    ...
                    <div class="row justify-content-center animate__animated animate__fadeInUp">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Masuk Aplikasi</h5>
                                        <p class="text-center small">Masukkan Nama Pengguna dan Kata Sandi Anda</p>
                                    </div>
                                    
                                    @if (session()->has('loginError'))
                                    <div class="m-0 mb-2 alert alert-danger alert-dismissible fade show" role="alert">
                                        {{ session('loginError') }}
